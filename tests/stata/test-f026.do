...
assert `"`e(cmdline)'"' == `"csdid y, ivar(id) time(time) gvar(g) method(reg) analytical"'
...
assert `"`e(cmdline)'"' == `"csdid y, time(time) gvar(g) method(reg) analytical"'
...
assert `"`e(cmdline)'"' == `"csdid y, ivar(id) time(time) gvar(g) method(reg) cluster(cl) analytical"'
