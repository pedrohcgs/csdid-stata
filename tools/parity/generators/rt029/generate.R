# RT029: R oracle for the point-estimate scenarios the Stata test exercises.
#
...
IN  <- "tests/fixtures/parity/rt029/inputs"
OUT <- "tests/fixtures/parity/rt029/expected/r"
...
cat(sprintf("RT029 oracle: %d attgt rows across %d scenarios, %d aggregations\n",
