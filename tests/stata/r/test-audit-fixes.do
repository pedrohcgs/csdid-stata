...
quietly csdid y, ivar(id) time(t) gvar(g) method(dr) analytical nevertreated base_period(varying) bal(none) storeall
matrix Seed1Default = e(attgt)
rt006_append_attgt, scenario("seed1_default") outfile("`actual_att'")
local first_att 0

import delimited using "`root'/tests/fixtures/parity/rt006/inputs/balanced-seed1.csv", clear asdouble
quietly csdid y, ivar(id) time(t) gvar(g) method(dr) fix_weights(varying) analytical nevertreated base_period(varying) bal(none) storeall
...
quietly csdid y, ivar(id) time(t) gvar(g) method(dr) fix_weights(varying) nofast analytical nevertreated base_period(varying) bal(none) storeall
matrix Seed2Slow = e(attgt)
rt006_append_attgt, scenario("seed2_varying_fast_false") outfile("`actual_att'") append

import delimited using "`root'/tests/fixtures/parity/rt006/inputs/balanced-seed2.csv", clear asdouble
quietly csdid y, ivar(id) time(t) gvar(g) method(dr) fix_weights(varying) fast analytical nevertreated base_period(varying) bal(none) storeall
...
quietly csdid lemp, ivar(countyreal) time(year) gvar(firsttreat) analytical nevertreated base_period(varying) bal(none) storeall
local first_norm 1
