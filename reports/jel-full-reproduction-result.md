...
- Side-by-side render sheet: `~/Documents/csdid/build/jel-full-reproduction/outputs/visual-review/stata-pdf-drift-side-by-side.png`

## Generated Evidence

- JSON summary: `~/Documents/csdid/build/jel-full-reproduction/outputs/summary.json`
- Artifact manifest: `~/Documents/csdid/build/jel-full-reproduction/outputs/artifact-manifest.csv`
- Artifact comparison: `~/Documents/csdid/build/jel-full-reproduction/outputs/artifact-comparison.csv`
- Figure label audit: `~/Documents/csdid/build/jel-full-reproduction/outputs/figure-label-audit.csv`
- Table 7 display audit: `~/Documents/csdid/build/jel-full-reproduction/outputs/table7-display-audit.csv`
- Stata figure semantic audit: `~/Documents/csdid/build/jel-full-reproduction/outputs/stata-figure-semantic-audit.csv`
- Logs directory: `~/Documents/csdid/build/jel-full-reproduction/logs`
- Stata batch log: `~/Documents/csdid/build/jel-full-reproduction/worktree/run-stata-master.log`
