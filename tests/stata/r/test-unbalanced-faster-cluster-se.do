...
quietly csdid y, ivar(id) time(period) gvar(g) method(reg) base_period(universal) cluster(cluster) nofast analytical nevertreated bal(none) storeall
...
import delimited using "`root'/tests/fixtures/parity/rt027/inputs/unbalanced-clustered.csv", clear asdouble
quietly csdid y, ivar(id) time(period) gvar(g) method(reg) base_period(universal) cluster(cluster) fast analytical nevertreated bal(none) storeall
...
import delimited using "`root'/tests/fixtures/parity/rt027/inputs/unbalanced-clustered.csv", clear asdouble
quietly csdid y, ivar(id) time(period) gvar(g) method(reg) base_period(universal) nofast analytical nevertreated bal(none) storeall
assert e(fast_requested) == 0
assert e(fast_allowed) == 0
assert e(fast_used) == 0
assert "`e(compute_path)'" == "baseline"
...
import delimited using "`root'/tests/fixtures/parity/rt027/inputs/unbalanced-clustered.csv", clear asdouble
quietly csdid y, ivar(id) time(period) gvar(g) method(reg) base_period(universal) fast analytical nevertreated bal(none) storeall
assert e(fast_requested) == 1
assert e(fast_used) == 1
assert "`e(compute_path)'" == "fast-allow-unbalanced"
