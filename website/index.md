...
<p class="tagline">A Stata package for difference-in-differences with multiple periods.</p>
...
## Citing csdid 
We ask that you cite *both* the method and the software when you use our `csdid` command: for the method,
Callaway and Sant'Anna (2021) above; for the software, cite the version you ran, which `csdid version`
reports for you.
