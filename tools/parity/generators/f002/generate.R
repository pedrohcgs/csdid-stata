...
script_path <- if (length(file_arg)) sub("^--file=", "", file_arg[[1]]) else "tools/parity/generators/f002/generate.R"
...
fixture <- file.path(root, "tests/fixtures/parity/f002")
...
manifest <- list(
  matrix_id = "F002",
  fixture_family = "attgt-balanced-staggered",
  ...
  generators = list(list(runtime = "R", command = "Rscript tools/parity/generators/f002/generate.R", path = "tools/parity/generators/f002/generate.R")),
